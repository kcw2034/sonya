...
from sonya_core.llm.models import LLMResponse, StopReason, Usage
...
class TestAgentRuntime:
    ...
    async def test_multiple_tool_calls(self):
        ...
        result = await agent.run("1+2와 3+4를 계산해줘")
    ...
    async def test_max_iterations_exceeded(self):
        ...
        mock_client.chat.return_value = _make_tool_use_response(
            "add", {"a": 1, "b": 1}
        )
